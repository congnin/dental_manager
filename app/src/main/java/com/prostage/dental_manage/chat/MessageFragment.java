...
public class MessageFragment extends BaseFragment implements View.OnClickListener,
    ...
    public static MessageFragment newInstance(UserModel userModel) {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        messageAdapter = new MessageAdapter(getActivity(), messageModels, Integer.parseInt(userModel.getGender()));

        titleBar.setTitle(userModel.getFirstNickName());
    ...
    private void getMessageData() {
        int senderId = Utils.getInt(getActivity(), Utils.PREF_ADMIN_ID);
        String receiverId = userModel.getUsername();
    ...
    private void sendMessage() {
        ...
        model.setSenderId(String.valueOf(senderId));

        chatRef.push().setValue(model).addOnSuccessListener(aVoid -> {

        }).addOnFailureListener(e -> Toast.makeText(MessageFragment.this.getActivity().getApplicationContext(),
    ...
    public void onPause() {
        ...
        String receiverId = userModel.getUsername();
        final Handler handler = new Handler();
        handler.postDelayed(() -> DBWriter.readMessage(String.valueOf(senderId), receiverId), 500);
