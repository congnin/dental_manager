...
class MessageAdapter extends RecyclerView.Adapter {
    ...
    MessageAdapter(Context context, ArrayList<MessageModel> models, int gender) {
    ...
    private void validateData(List<MessageModel> messageModelList) {
    ...
    private static class ReceiverHolder extends RecyclerView.ViewHolder {
        ...
        ReceiverHolder(View view) {
            super(view);
            tvHeaderTime = view.findViewById(R.id.tv_item_time);
            ivAvatarReceiver = view.findViewById(R.id.iv_receiver_item_avatar);
            tvMessageReceiver = view.findViewById(R.id.tv_receiver_content_chat);
            tvTimeReceiver = view.findViewById(R.id.tv_receiver_time_chat);
            receiverLayout = view.findViewById(R.id.item_receiver_layout);
        }
    }

    private static class SenderHolder extends RecyclerView.ViewHolder {
        ...
        SenderHolder(View view) {
            super(view);
            tvMessageSender = view.findViewById(R.id.tv_sender_content_chat);
            tvTimeSender = view.findViewById(R.id.tv_sender_time_chat);
            tvHeaderTime = view.findViewById(R.id.tv_item_time);
            senderLayout = view.findViewById(R.id.item_sender_layout);
        }
    }

    private static class ImageReceiverHolder extends RecyclerView.ViewHolder {
        TextView tvHeaderTime;
        TextView tvTimeReceiver;
        ImageView ivPhoto;
//        ImageView ivAvatar;
        ...
        ImageReceiverHolder(View view) {
            super(view);
            tvHeaderTime = view.findViewById(R.id.tv_item_time);
            tvTimeReceiver = view.findViewById(R.id.tv_receiver_time_chat);
            ivPhoto = view.findViewById(R.id.iv_receiver_image);
//            ivAvatar = view.findViewById(R.id.iv_receiver_item_avatar);
            receiverLayout = view.findViewById(R.id.item_receiver_layout);
            progressBar = view.findViewById(R.id.pgb_load);
        }
    }

    private static class ImageSenderHolder extends RecyclerView.ViewHolder {
        TextView tvHeaderTime;
        TextView tvTimeSender;
        ImageView ivPhoto;
        LinearLayout senderLayout;
        ...
        ImageSenderHolder(View view) {
            super(view);
            tvHeaderTime = view.findViewById(R.id.tv_item_time);
            tvTimeSender = view.findViewById(R.id.tv_sender_time_chat);
            ivPhoto = view.findViewById(R.id.iv_sender_image);
            senderLayout = view.findViewById(R.id.item_sender_layout);
            progressBar = view.findViewById(R.id.pgb_load);
        }
    }
